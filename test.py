...
greedy_player = utils.create_inactive_player("Heuristic", r)
...
num_episodes = 1 #Total number of episodes to train network for.
tau = 0.001 #Amount to update target network at each step.
batch_size = 32 #Size of training batch
startE = 0 #Starting chance of random action
endE = 0.1 #Final chance of random action
annealing_steps = 20000 #How many steps of training to reduce startE to endE.
pre_train_steps = 30000 #Number of steps used before training updates begin.
...
with tf.Session() as sess:
    sess.run(init)
    saver.restore(sess, "saved_models/greedy/approx_greedy_model.ckpt")
